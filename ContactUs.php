  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="ContactUs.php" style="font-family: 'Lobster', cursive;">CONTACT US</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right" style="font-family: 'Lobster', cursive;">
          ...
          <img src="Photo\cont.png" class="img-responsive" style="width: 100%;" alt="Image">
    </div>
  </div>
</nav>
